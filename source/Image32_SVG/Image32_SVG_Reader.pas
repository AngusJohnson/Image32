...
//  end;
  ...
  TDrawInfo = record
    ...
    matrix        : TMatrixD;
    visible       : Boolean;
    InUse         : Boolean; //<USE> attribs override ref element attribs.
  end;
...
const
  ...
  emptyDrawInfo: TDrawInfo =
    ...
    matrix: ((1, 0, 0),(0, 1, 0),(0, 0, 1)); visible: true; InUse: false);
...
begin
  ...
  UpdateDrawInfo(drawInfo, fDrawInfo); //nb: <use> attribs override el's.
